        ...
        <div className="max-w-7xl mx-auto flex h-14 items-center justify-between px-4 md:px-8">
          ...
          <div className="flex items-center gap-1.5 md:gap-2">
            ...
            {pathname !== '/founders' && (
              <Link
                href="/founders"
                className="hidden md:inline-flex items-center gap-1.5 text-xs font-medium text-muted-foreground hover:text-foreground transition-colors px-2.5 py-1.5 rounded-lg hover:bg-muted/60"
              >
            ...
            {ready && !user && isPublic && pathname !== '/login' && (
              <Link
                href="/login"
                className="inline-flex items-center justify-center rounded-lg px-3.5 py-1.5 text-xs font-semibold text-primary-foreground bg-primary hover:bg-primary/90 shadow-2xs transition-all active:scale-[0.98]"
              >
                {t("loginLabel")}
              </Link>
            )}
