    ...
    <div className="space-y-8 max-w-6xl mx-auto pb-12 relative">
      ...
      >
        ...
        <h1 className="text-2xl md:text-3xl font-bold font-display tracking-tight text-foreground">
          {lang === 'hi' ? 'मेरा डिजिटल ' : 'My Digital '}<span className="text-emerald-600 dark:text-emerald-400">{lang === 'hi' ? 'बहीखाता' : 'Farm Logbook'}</span>
        </h1>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
            ...
            <form onSubmit={handleAddEntry} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full h-10 rounded-xl bg-background border border-border/50 focus:border-emerald-500 px-3.5 text-sm text-foreground focus:outline-none transition-colors"
                  required
                />
              </div>
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full h-10 rounded-xl bg-background border border-border/50 focus:border-emerald-500 px-3 text-sm text-foreground focus:outline-none transition-colors cursor-pointer"
                >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      placeholder="0"
                      className="w-full h-10 rounded-xl bg-background border border-border/50 focus:border-emerald-500 pl-7 pr-3.5 text-sm text-foreground focus:outline-none transition-colors"
                      required
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full h-20 rounded-xl bg-background border border-border/50 focus:border-emerald-500 p-3 text-sm text-foreground focus:outline-none transition-colors resize-none"
                  required
                />
              </div>

              <Button type="submit" className="w-full h-10 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold flex items-center justify-center gap-2 shadow-sm">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="p-4 rounded-xl border border-border/50 bg-card flex items-center justify-between shadow-sm">
              <div>
                <span className="text-[11px] uppercase font-semibold text-muted-foreground tracking-wider">{lang === 'hi' ? 'कुल व्यय' : 'Total Expense'}</span>
                <p className="text-xl font-black text-rose-600 dark:text-rose-400 font-display mt-0.5">₹{totalExpense}</p>
              </div>
            ...
            <div className="p-4 rounded-xl border border-border/50 bg-card flex items-center justify-between shadow-sm">
              <div>
                <span className="text-[11px] uppercase font-semibold text-muted-foreground tracking-wider">{lang === 'hi' ? 'कुल आय' : 'Total Income'}</span>
                <p className="text-xl font-black text-emerald-600 dark:text-emerald-400 font-display mt-0.5">₹{totalIncome}</p>
              </div>
            ...
            <div className="p-4 rounded-xl border border-border/50 bg-card flex items-center justify-between shadow-sm">
              <div>
                <span className="text-[11px] uppercase font-semibold text-muted-foreground tracking-wider">{lang === 'hi' ? 'शुद्ध लाभ' : 'Net Income'}</span>
                <p className={`text-xl font-black font-display mt-0.5 ${netProfit >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'}`}>
                  ₹{netProfit}
                </p>
              </div>
              <div className={`h-9 w-9 rounded-lg flex items-center justify-center ${netProfit >= 0 ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400' : 'bg-rose-500/10 text-rose-600 dark:text-rose-400'}`}>
          ...
          {/* Logs View */}
          <div className="border border-border/50 bg-card p-6 rounded-2xl shadow-sm">
            <div className="pb-4 mb-4 border-b border-border/40 flex flex-row items-center justify-between">
              <h3 className="text-base font-bold text-foreground font-display">
                {lang === 'hi' ? 'बहीखाता रिकॉर्ड' : 'Logbook Entries'}
              </h3>
              <span className="text-[10px] font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-0.5 rounded-full select-none">
                ...
                {logs.length === 0 ? (
                  ...
                  logs.map(log => (
                    <motion.div
                      ...
                      className="p-3.5 rounded-xl border border-border/40 bg-muted/20 hover:bg-muted/40 flex items-center justify-between gap-4 transition-all"
                    >
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded ${
                            log.category === 'expense' ? 'bg-rose-500/10 text-rose-600 dark:text-rose-400' :
                            log.category === 'income' ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400' : 'bg-blue-500/10 text-blue-600 dark:text-blue-400'
                          }`}>
                            {log.category === 'expense' ? (lang === 'hi' ? 'खर्च' : 'Expense') :
                             log.category === 'income' ? (lang === 'hi' ? 'आय' : 'Income') : (lang === 'hi' ? 'कार्य' : 'Task')}
                          </span>
                          <span className="text-[11px] text-muted-foreground font-medium">{log.date}</span>
                          <span className="text-[11px] text-emerald-700 dark:text-emerald-400 font-semibold bg-emerald-500/5 border border-emerald-500/15 px-2 py-0.5 rounded-full">{log.crop}</span>
                        </div>
                        <p className="text-xs font-medium text-foreground leading-relaxed">{log.activity}</p>
                      </div>

                      <div className="flex items-center gap-3">
                        {log.category !== 'activity' && (
                          <span className={`text-sm font-bold font-display ${log.category === 'income' ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'}`}>
                            {log.category === 'income' ? '+' : '-'} ₹{log.amount}
                          </span>
                        )}
                        <button 
                          onClick={() => handleDelete(log.id)}
                          className="p-2 rounded-lg bg-background border border-border/40 text-muted-foreground hover:text-rose-600 hover:bg-rose-500/10 transition-colors"
                        >
        ...
        {lang === "hi" ? (
          <div className="space-y-8 text-foreground">
            <div className="space-y-3">
              <h2 className="text-xl md:text-2xl font-display font-bold text-foreground">🌾 खेत डायरी क्या है और डिजिटल रिकॉर्ड क्यों आवश्यक हैं?</h2>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="p-5 rounded-2xl border border-border/50 bg-card space-y-3 shadow-sm">
                <h3 className="text-base font-bold text-emerald-600 dark:text-emerald-400 font-display">📈 व्यय और उपज का सटीक ट्रैकिंग गाइड</h3>
              ...
              <div className="p-5 rounded-2xl border border-border/50 bg-card space-y-3 shadow-sm">
                <h3 className="text-base font-bold text-emerald-600 dark:text-emerald-400 font-display">📁 सरकारी दस्तावेज़ीकरण और डिजिटल रिकॉर्ड के लाभ</h3>
                <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <div className="space-y-4">
              <h2 className="text-xl font-display font-bold text-foreground">❓ खेत डायरी और रिकॉर्ड रखने के बारे में FAQs</h2>
              <div className="grid gap-3 md:grid-cols-2 text-xs text-muted-foreground">
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q1. खेत डायरी में मुझे क्या-क्या जानकारी लिखनी चाहिए?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q2. क्या मैं इस डेटा को एक्सेल (Excel) या पीडीएफ (PDF) में डाउनलोड कर सकता हूँ?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q3. क्या यह रिकॉर्ड फसल ऋण (KCC) प्राप्त करने में मदद करेगा?</h4>
                  <p>हाँ, बैंक अधिकारी किसान की वित्तीय स्थिरता और कृषि खर्चों के अनुशासन को देखकर केसीसी ऋण सीमा आसानी से बढ़ा देते हैं।</p>
                </div>
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q4. क्या केसीसी (KCC) लोन के लिए फसल चक्र का रिकॉर्ड रखना जरूरी है?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q5. फसल बीमा (Fasal Bima) क्लेम में यह डायरी कैसे उपयोगी है?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q6. क्या मेरी डायरी का विवरण अन्य किसानों को दिखाई देगा?</h4>
                  <p>नहीं, आपका व्यक्तिगत खेत बहीखाता पूरी तरह से सुरक्षित और निजी है। इसे केवल आप ही देख सकते हैं।</p>
                </div>
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q7. उत्पादन लागत (Cost of Production) की गणना कैसे करें?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q8. क्या मैं एक साथ कई अलग-अलग खेतों (मेड़ों) का हिसाब रख सकता हूँ?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q9. क्या डिजिटल रिकॉर्ड रखने से टैक्स (कर) में कोई छूट मिलती है?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q10. क्या KisaanBuddy का ऑफलाइन बहीखाता उपलब्ध है?</h4>
          ...
          <div className="space-y-8 text-foreground">
            <div className="space-y-3">
              <h2 className="text-xl md:text-2xl font-display font-bold text-foreground">🌾 What is Khet Diary and Why Are Digital Records Vital?</h2>
              <p className="text-muted-foreground text-xs md:text-sm leading-relaxed max-w-4xl">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="p-5 rounded-2xl border border-border/50 bg-card space-y-3 shadow-sm">
                <h3 className="text-base font-bold text-emerald-600 dark:text-emerald-400 font-display">📈 Expense and Yield Tracking Guidelines</h3>
                <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              <div className="p-5 rounded-2xl border border-border/50 bg-card space-y-3 shadow-sm">
                <h3 className="text-base font-bold text-emerald-600 dark:text-emerald-400 font-display">📁 Government Documentation and Digital Advantages</h3>
                <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <div className="space-y-4">
              <h2 className="text-xl font-display font-bold text-foreground">❓ Farm Logbook & Ledger FAQs</h2>
              <div className="grid gap-3 md:grid-cols-2 text-xs text-muted-foreground">
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q1. What specific entries should I write down in Khet Diary?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q2. Can I export my digital records to Excel or PDF format?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q3. Does the ledger assist in bank loans?</h4>
                  <p>Yes, presenting systematic production costs and cash flows builds bank trust, facilitating credit card clearances.</p>
                </div>
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q4. Is crop cycle history verified for KCC updates?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q5. How does this help in crop insurance claims?</h4>
                  <p>It acts as evidence of crop planting times, inputs, and investments if fields get waterlogged or affected by drought.</p>
                </div>
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q6. Is my farm ledger data shared publicly?</h4>
                  <p>No, your farm diary entries are completely encrypted, private, and visible only to you on your registered account.</p>
                </div>
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q7. How do I calculate my crop's unit production cost?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q8. Can I manage multiple fields inside the same diary?</h4>
                  <p>Yes, you can tag entries with specific survey numbers or land descriptors to split accounts between different plots.</p>
                </div>
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q9. Are agricultural profits subject to tax in India?</h4>
                ...
                <div className="p-4 rounded-xl border border-border/50 bg-card space-y-1.5 shadow-sm">
                  <h4 className="font-semibold text-foreground">Q10. Can I write entries without a network connection?</h4>
