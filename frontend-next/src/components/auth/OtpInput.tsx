    ...
    <div className="flex justify-between gap-2 sm:gap-3" role="group" aria-label="Six-digit verification code">
      {digits.map((digit, index) => (
        <input
          ...
          className="h-12 min-w-0 flex-1 rounded-xl border border-white/10 bg-white/[0.03] text-center font-mono text-xl font-bold text-white outline-none transition focus:border-emerald-400 focus:bg-white/[0.06] focus:ring-2 focus:ring-emerald-400/20 disabled:cursor-not-allowed disabled:opacity-50"
          disabled={disabled}
          inputMode="numeric"
